        ...
        <div className="container py-4 text-white">
            <div className="row justify-content-center mb-4">
                <div className="col-12 text-center">
                    ...
                    <p className="lead text-white-50">An immersion into the world of {videogame.title}.</p>
                </div>
            </div>
                    ...
                    <div className="bg-dark p-4 rounded shadow-lg d-md-flex align-items-stretch">
                        <div className="col-12 col-md-5 mb-4 mb-md-0 d-flex align-items-center justify-content-center">
                            <figure className="mb-0 w-100">
                                <img
                                    ...
                                    src={videogame.imageUrl || "https://via.placeholder.com/500x700/6c757d/FFFFFF?text=Image+Not+Available"}
                                    alt={videogame.title || "Videogame image"}
                        ...
                        <div className="col-12 col-md-7 ps-md-4">
                            ...
                            <div className="mt-4 text-center">
                                <button className="btn btn-outline-light btn-lg px-4" onClick={() => window.history.back()}>
                                    <IoArrowBack /> Go Back
                                </button>
                            </div>
                        </div>
